...
if (isset($_POST["login"]) && isset($_POST["password"])) {
    ...
    header('Location: user-correction.php'); // on retourne sur user.php (refresh)
} 
...
<p>Identifiant = <?= isset($_COOKIE['login']) ? $_COOKIE['login'] : "" ?></p>
<p>Mot de passe = <?= isset($_COOKIE['password']) ? $_COOKIE['password'] : "" ?></p>
<!-- Bouton qui permet de revenir à l'index et donc de modifier les cookies -->
